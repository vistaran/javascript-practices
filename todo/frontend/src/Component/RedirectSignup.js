                ...
                <div className="row">
                    <div className="col-md-4"></div>
                        <div className="col-md-4 login-form" style={{textAlign: "center",border: "2px",border: "solid", border:"floralwhite", borderRadius: "25px"}}>
                                ...
                                {error && <p className="log_text" style={{color:"red"}}>You Have already refgister.</p>}
                                {success && <p className="log_text" style={{color:"green"}}>You are Ragister Now you are login.</p>}
